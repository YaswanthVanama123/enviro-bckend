...
\newcommand{\serviceSection}[1]{%
  {\bfseries\normalsize\textcolor{emred}{\underline{#1}}\par}%
  \vspace{0.7em}%
}
...
\newcommand{\agreementBlank}[2][2.5cm]{%
  \makebox[#1][c]{%
    \makebox[0pt][c]{\textcolor{linegray}{\rule{#1}{\filledlineheight}}}%
    \makebox[0pt][c]{\raisebox{\filledlineoffset}{#2}}% ✅ Lift text above line
  }%
}
...
\fcolorbox{black}{emred}{%
  \parbox{\dimexpr\textwidth-2\fboxsep\relax}{%
    \centering
    \vspace{0.2em}%
    {\bfseries\fontsize{1.2em}{3.8em}\selectfont\textcolor{white}{SERVICES}}% ✅ Changed from \footnotesize to \normalsize
    \vspace{0.2em}%
  }%
}%  
\vspace{1.5em}%
