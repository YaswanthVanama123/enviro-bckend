...
\newcommand{\filledline}[1]{%
  ...
  \makebox[\linewidth][c]{%
    ...
    \makebox[0pt][c]{\raisebox{\filledlineoffset}{\strut #1}}% ✅ Lift text above line
  }%
}
...
{{#summaryExists}}
\vspace{1.1em}
\serviceBigHeading{AGREEMENT SUMMARY}
\vspace{0.7em}
\serviceTotalLine{Contract Months:}{\textcolor{totalcolor}{{{summaryContractMonthsDisplay}}}}
\serviceTotalLine{Trip Charge:}{\textcolor{totalcolor}{{{summaryTripChargeLabel}}}}
\serviceTotalLine{Parking Charge:}{\textcolor{totalcolor}{{{summaryParkingChargeLabel}}}}
\serviceTotalLine{Service Total:}{\textcolor{totalcolor}{{{summaryServiceAgreementTotal}}}}
% \serviceTotalLineWide{Service Agreement Total:}{\textcolor{totalcolor}{{{summaryServiceAgreementTotal}}}}
\serviceTotalLine{Product Totals:}{\textcolor{totalcolor}{{{summaryProductTotalsLabel}}}}
{{/summaryExists}}
