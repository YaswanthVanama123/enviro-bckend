...
\definecolor{linegray}{RGB}{120,120,120} % ✅ DARKER gray for better visibility
...
\setlength{\serviceGapWide}{1.6em}
...
\fcolorbox{emred}{emred}{%
  \parbox{\dimexpr\textwidth-2\fboxsep\relax}{%
    \centering
    \bfseries\normalsize\textcolor{white}{PRODUCTS}% ✅ Changed from \footnotesize to \normalsize
  }%
}
...
\fcolorbox{emred}{emred}{%
  \parbox{\dimexpr\textwidth-2\fboxsep\relax}{%
    \centering
    \bfseries\normalsize\textcolor{white}{SERVICES}% ✅ Changed from \footnotesize to \normalsize
  }%
}
