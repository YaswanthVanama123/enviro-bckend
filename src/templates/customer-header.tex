...
\vspace{0.3em}
\serviceTotalLine{Contract Months:}{\textcolor{totalcolor}{\strut {{{summaryContractMonthsDisplay}}}}}
\serviceTotalLine{Trip Charge:}{\textcolor{totalcolor}{\strut {{{summaryTripChargeLabel}}}}}
\serviceTotalLine{Parking Charge:}{\textcolor{totalcolor}{\strut {{{summaryParkingChargeLabel}}}}}
\serviceTotalLine{Service Totals:}{\textcolor{totalcolor}{\strut {{{summaryServiceAgreementTotal}}}}}
\serviceTotalLine{Product Totals:}{\textcolor{totalcolor}{\strut {{{summaryProductTotalsLabel}}}}}
{{/summaryExists}}
